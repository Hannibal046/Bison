...
from pfhedge.stochastic import generate_garch

from .base import BasePrimary


class GarchStock(BasePrimary):
    ...
    def __init__(
        self,
        mu: float = 0.031748,
        omega: float = 0.020680,
        alpha: float = 0.083879,
        gamma: float = 0.013184,
        beta: float = 0.903687,
        cost: float = 0.0,
        dt: float = 1 / 250,
...
_set_docstring(GarchStock, "default_init_state", BasePrimary.default_init_state)
_set_attr_and_docstring(GarchStock, "to", BasePrimary.to)
